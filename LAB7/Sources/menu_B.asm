...
; export symbols
            ...
            XREF __SEG_END_SSTACK, SUB_delay, lcd_write, rtc_get_time,rtc_write_tod
			...
			XREF lcd_goto_row1, lcd_goto_row0, led_write, led_data, keypad_get_keypress, lcd_goto_addr, sub_B_1
