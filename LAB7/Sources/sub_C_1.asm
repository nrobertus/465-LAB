...
goto_print_heating_2:
		JMP print_heating

goto_print_cooling_2:
		JMP print_cooling
...
goto_print_heating:
		JMP goto_print_heating_2

goto_print_cooling:
		JMP goto_print_cooling_2
...
holding_pattern:
		...
		BLT goto_print_heating
		
		BNE goto_print_cooling
