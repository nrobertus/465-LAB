...
;**     Date/Time   : 2015-01-29, 15:00, # CodeGen: 2
;**     Abstract    :
...
SkipTrim:
  ...
  ; ### Init_TPM init code 
        ...
        ; TPMSC: TOF=0,TOIE=1,CPWMS=0,CLKSB=0,CLKSA=1,PS2=1,PS1=1,PS0=0 
        MOV     #$4E,TPMSC             ; Int. flag clearing (2nd part) and timer control register setting 
  ; ### Init_GPIO init code 
