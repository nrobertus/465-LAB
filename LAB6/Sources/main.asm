...
; export symbols
            ...
            XREF __SEG_END_SSTACK, get_input, lm92_init, lm92_read_temp, lm92_write_lcd_C, lcd_init, lcd_clear, mode_0, mode_1, mode_2, i2c_init ; symbol defined by the linker for the end of the stack
